...
public class CssSelectorTest {
    ...
    public void cssSelectorsTest() {
        driver.get("file:/Users/ilya2.0/IdeaProjects/lesson7_hw/src/test/resources/index.html");
        ...
        Assert.assertEquals(0, driver.findElements(By.cssSelector("div.intro #Lastname .markup")).size());
        ...
        Assert.assertEquals(15, driver.findElements(By.cssSelector("p > span")).size());
        ...
        Assert.assertEquals(1, driver.findElements(By.cssSelector("[title='Hello beautiful']")).size());
        ...
        Assert.assertEquals(2, driver.findElements(By.cssSelector("[id^=Lis]")).size());
